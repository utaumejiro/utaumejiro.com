...
if (worldSection) worldSection.insertAdjacentHTML('beforebegin', `<section class="schedule" id="schedule"><div class="schedule-inner"><div><p class="overline">SCHEDULE</p><h2>出演予定</h2></div><div class="schedule-list"><article class="schedule-item"><time>2026年7月20日</time><div><b>新しい盆踊りの音　第二回</b><span>出演済み</span></div></article><article class="schedule-item"><time>2026年8月18日・19日<br>24日・25日のいずれか</time><div><b>サマテイ</b><span>出演予定</span></div></article></div></div></section>`);
